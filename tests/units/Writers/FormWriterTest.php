...
class FormWriterTest extends TestCase
{
    ...
    public function can_create_index()
    {
        ...
        $this->assertControllerContains('namespace App\Http\Controllers\Group\TestModels;', 'Index');
    ...
    public function can_create_show()
    {
        ...
        $this->assertControllerContains('namespace App\Http\Controllers\Group\TestModels;', 'Show');
    ...
    public function can_create_create()
    {
        ...
        $this->assertControllerContains('namespace App\Http\Controllers\Group\TestModels;', 'Create');
    ...
    public function can_create_destroy()
    {
        ...
        $this->assertControllerContains('namespace App\Http\Controllers\Group\TestModels;', 'Destroy');
    ...
    public function can_create_update()
    {
        ...
        $this->assertControllerContains('namespace App\Http\Controllers\Group\TestModels;', 'Update');
        $this->assertControllerContains('use Classes\\TestModel;', 'Update');
        $this->assertControllerContains('use App\\Http\\Requests\\Group\\TestModels\\ValidateTestModelUpdate', 'Update');
    ...
    public function can_create_store()
    {
        ...
        $this->assertControllerContains('namespace App\Http\Controllers\Group\TestModels;', 'Store');
        $this->assertControllerContains('use Classes\\TestModel;', 'Store');
        $this->assertControllerContains('use App\\Http\\Requests\\Group\\TestModels\\ValidateTestModelStore', 'Store');
