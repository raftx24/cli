...
class ValidatorTest extends TestCase
{
    ...
    {
        $this->choices->get('model')->put('name', 'namespace//testModel');
    ...
    {
        $this->choices->get('model')->put('name', 'namespace\\testModel');
    ...
    {
        $this->choices->put('menu', new Obj(['route' => 'route.create', 'parentMenu' => 'not_menu']));
    ...
    {
        $this->choices->put('menu', new Obj(['route' => 'route.create', 'parentMenu' => 'parent']));

        $this->createParentMenu()->createParentMenu();
    ...
    {
        Menu::create(['name' => 'parent', 'has_children' => true]);
